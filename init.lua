...
vim.keymap.set('n', '<leader>cd', vim.diagnostic.open_float, { desc = 'Open [C]ode [D]iagnostics' })
...
end, { desc = 'Goto next [E]rror' })
vim.keymap.set('n', '[e', function()
  vim.diagnostic.goto_prev { severity = { min = vim.diagnostic.severity.ERROR } }
end, { desc = 'Goto prev [E]rror' })
vim.keymap.set('n', ']w', function()
  vim.diagnostic.goto_next { severity = { min = vim.diagnostic.severity.WARN } }
end, { desc = 'Goto next [W]arning' })
vim.keymap.set('n', '[w', function()
  vim.diagnostic.goto_prev { severity = { min = vim.diagnostic.severity.WARN } }
end, { desc = 'Goto prev [W]arning' })
...
vim.keymap.set('n', '<leader>bd', '<Cmd>BufferClose<CR>', { desc = '[B]uffer - [D]elete (close)' })
vim.keymap.set('n', '<leader>bo', '<Cmd>BufferCloseAllButCurrent<CR>', { desc = '[B]uffer - Close [O]thers' })
vim.keymap.set('n', '<leader>bl', '<Cmd>BufferCloseBuffersLeft<CR>', { desc = '[B]uffer - Close to [L]eft' })
vim.keymap.set('n', '<leader>br', '<Cmd>BufferCloseBuffersRight<CR>', { desc = '[B]uffer - Close [R]ight' })
